...
class Utility:
    ...
    def display_integrated_signal(self):
        ...
        fig, ax = plt.subplots(1,1, figsize=(8, 8))
        im = ax.imshow(self.data_integrated, cmap='gray')
        plt.colorbar(im, ax=ax)
    ...
    def select_open_beam_region(self):
        def plot_roi(x, y, width, height, log_scale):
            ...
            axs[1].plot(self.lambda_axis, ob_profile_region)
    ...
    def perform_normalization(self):
        ...
        def plot_roi(x, y, width, height, log_scale):
            ...
            ax[1].plot(self.lambda_axis, sample_profile_region)
