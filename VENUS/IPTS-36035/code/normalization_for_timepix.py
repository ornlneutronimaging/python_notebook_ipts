...
from code.units import convert_array_from_time_to_lambda, convert_array_from_time_to_energy
from code.units import TimeUnitOptions, DistanceUnitOptions, EnergyUnitOptions
...
log_file_name = os.path.join(LOG_PATH, f"ipts_36035_{user_name}_{file_name}.log")
...
def normalization_with_list_of_runs(sample_run_numbers: list = None, 
    ...
    for _ob_run_number in ob_master_dict.keys():
        ...
        shutter_time = ob_master_dict[_ob_run_number][MasterDictKeys.list_spectra]
    ...
    return normalized_data, lambda_array, energy_array, shutter_time
